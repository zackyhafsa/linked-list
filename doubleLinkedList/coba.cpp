...
int main(){
  ...
  string newData[4] = {"Zacky Hafsari", "zackyyy", "masjek@gmail.com", "apaaja"};
  createDoubleLinkedList(newData);

  printDoubleLinkedList();

  string data2[4] = {"Abrar Wahid", "abrarrw", "abrar@gmail.com", "duhkumahanyah"};

  addFirst( data2 );

  printDoubleLinkedList();

  string data3[4] = {"Ahmad Nur'ain", "ahmadddd", "ahmad0999@gmail.com", "ahmadganteng"};

  addLast( data3 );

  printDoubleLinkedList();

  string data4[4] = {"Ervan Satrya", "erpann", "ervankasep@yahoo.com", "ervankasep0012"};
  addMiddle(data4, 3);
